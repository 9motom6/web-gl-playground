 ...
 */
export function loadShader(gl: WebGLRenderingContext, shaderSource: string, shaderType: GLenum): WebGLShader {
...
export function createProgramFromSources(
    gl: WebGL2RenderingContext, shaderSources: string[], optAttribs?: string[], optLocations?: number[]): WebGLProgram {
    const shaders = [];
